...
if __name__ == '__main__':
	...
	for data_type in data_types:
		data_dir = '/data3/manuscript_v1.8_repaired_pairwise/' + data_type
		...
		# mask_list = ['deepcell_membrane', 'deepcell_cyto', 'deepcell_membrane_new', 'deepcell_cyto_new', 'cellpose', 'cellpose_new', 'cellprofiler', 'CellX', 'aics_classic', 'cellsegm', 'artificial']
	...
	plt.ylim(0, 14)
	plt.tight_layout()
	plt.savefig(join(save_dir, 'pairwise_metrics.png'), dpi=500)
